                        ...
                        <div class="semester-apply">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 item">
                                    <h4>Semester 1-4</h4>
                                    <p>
                                        Untuk kalian yang ingin mengerjakan latihan-latihan semester, ayo bergabung dengan kami !
                                    </p>
                                    <a class="btn btn-dark effect btn-sm" href="#"><i class="fas fa-angle-right"></i> Ikuti Sekarang</a>
                                </div>
                                <div class="col-md-6 col-sm-6 item">
                                    <h4>Beasiswa</h4>
                                    <p>
                                        Tantang dirimu dengan mengikuti beasiswa kami sesuai dengan minat dan keahlianmu!
                                    </p>
                                    <a class="btn btn-dark effect btn-sm" href="#"><i class="fas fa-angle-right"></i> Ikuti Sekarang</a>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="advisor-items text-light text-center">
                    ...
                    <!-- End Single item -->
                    <!-- Single item -->
                    <div class="col-md-3 col-sm-6 single-item"6>
                        <div class="item">
                            <div class="thumb">
                            ...
                            <div id="portfolio-grid" class="portfolio-items col-3">
                                <div class="pf-item ceremony students">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/1.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Philosophy</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/1.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                ...
                                <div class="pf-item teachers ceremony">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/2.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Contemporary Art</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/2.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                            <a href="#"><i class="fas fa-link"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pf-item campus education">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/3.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Geometry Course</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/3.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                            <a href="#"><i class="fas fa-link"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pf-item education students">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/4.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Biology Course</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/4.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                            <a href="#"><i class="fas fa-link"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pf-item teachers campus">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/5.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Live Drawing</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/5.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                            <a href="#"><i class="fas fa-link"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pf-item ceremony teachres">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url() ?>assets/img/gallery/6.jpg" alt="thumb" />
                                        <div class="overlay">
                                            <h4>Informatic Course</h4>
                                            <a href="<?php echo base_url() ?>assets/img/gallery/6.jpg" class="item popup-link"><i class="fa fa-plus"></i></a>
                                            <a href="#"><i class="fas fa-link"></i></a>
                                        </div>
                                    </div>
                                </div>
