...
<body>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow dark bg-fixed text-center text-light" style="background-image: url(/lms/assets/img/banner/19.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="top-course-items">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <img src="<?php echo base_url() ?>assets/img/courses/css.jpg" style="width: 400px; height: 230px;" alt="Thumb">
                                <div class="overlay">
                                    <a href="#">
                                        <img src="<?php echo base_url() ?>assets/img/team/1.jpg" alt="Thumb">
                                    </a>
                                    <ul>
                                        <li><i class="fas fa-clock"></i> 04:15:38</li>
                                        <li><i class="fas fa-list-ul"></i> 18</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="info">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <img src="<?php echo base_url() ?>assets/img/courses/php.jpg" style="width: 400px; height: 230px;" alt="Thumb">
                                <div class="overlay">
                                    <a href="#">
